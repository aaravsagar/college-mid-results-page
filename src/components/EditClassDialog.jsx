...
function EditClassDialog({ open, onClose, classData, onUpdate }) {
  ...
  const handleSubmit = (e) => {
    ...
    onUpdate(classData.id, { className, branch, semester, division });
  };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h3 style={{ borderBottom: "1px solid #ccc", paddingBottom: "5px", marginBottom: "15px" }}>Edit Class</h3>
